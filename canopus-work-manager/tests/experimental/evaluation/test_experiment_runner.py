...
from canopusinfosystems.experimental.evaluation.experiment.runner import ExperimentRunner
from canopusinfosystems.experimental.evaluation.experiment.result import ExperimentResults
from canopusinfosystems.experimental.evaluation.evaluation_display import AgentAggregatedEvaluationResult
from canopusinfosystems.experimental.evaluation.base_evaluator import MetricCategory, EvaluationScore
...
class TestExperimentRunner:
    ...
    @patch('canopusinfosystems.experimental.evaluation.experiment.runner.create_default_evaluator')
