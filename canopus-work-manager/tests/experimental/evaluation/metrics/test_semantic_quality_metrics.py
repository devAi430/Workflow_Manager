...
from canopusinfosystems.experimental.evaluation.base_evaluator import EvaluationScore
from canopusinfosystems.experimental.evaluation.metrics.semantic_quality_metrics import SemanticQualityEvaluator
from tests.experimental.evaluation.metrics.base_evaluation_metrics_test import BaseEvaluationMetricsTest
from canopusinfosystems.utilities.llm_utils import LLM

class TestSemanticQualityEvaluator(BaseEvaluationMetricsTest):
    @patch("canopusinfosystems.utilities.llm_utils.create_llm")
