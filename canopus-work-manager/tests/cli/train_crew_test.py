...
from canopusinfosystems.cli.train_crew import train_crew


@mock.patch("canopusinfosystems.cli.train_crew.subprocess.run")
...
@mock.patch("canopusinfosystems.cli.train_crew.click")
