...
from canopusinfosystems.cli.authentication.utils import TokenManager, validate_jwt_token


@patch("canopusinfosystems.cli.authentication.utils.PyJWKClient", return_value=MagicMock())
@patch("canopusinfosystems.cli.authentication.utils.jwt")
...
class TestTokenManager(unittest.TestCase):
    ...
    @patch("canopusinfosystems.cli.authentication.utils.TokenManager.read_secure_file")
    @patch("canopusinfosystems.cli.authentication.utils.TokenManager.save_secure_file")
    @patch("canopusinfosystems.cli.authentication.utils.TokenManager._get_or_create_key")
    ...
    @patch("canopusinfosystems.cli.authentication.utils.Fernet.generate_key")
    @patch("canopusinfosystems.cli.authentication.utils.TokenManager.read_secure_file")
    @patch("canopusinfosystems.cli.authentication.utils.TokenManager.save_secure_file")
    ...
    @patch("canopusinfosystems.cli.authentication.utils.TokenManager.get_secure_storage_path")
    @patch("builtins.open", new_callable=unittest.mock.mock_open)
    @patch("canopusinfosystems.cli.authentication.utils.os.chmod")
