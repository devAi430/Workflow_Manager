...
from canopusinfosystems.cli.authentication.main import AuthenticationCommand
from canopusinfosystems.cli.authentication.constants import (
    AUTH0_AUDIENCE,
    AUTH0_CLIENT_ID,
    AUTH0_DOMAIN,
    WORKOS_DOMAIN,
...
class TestAuthenticationCommand:
    ...
    @patch(
        "canopusinfosystems.cli.authentication.main.AuthenticationCommand._determine_user_provider"
    )
    @patch("canopusinfosystems.cli.authentication.main.AuthenticationCommand._get_device_code")
    @patch(
        "canopusinfosystems.cli.authentication.main.AuthenticationCommand._display_auth_instructions"
    )
    @patch("canopusinfosystems.cli.authentication.main.AuthenticationCommand._poll_for_token")
    @patch("canopusinfosystems.cli.authentication.main.console.print")
    def test_login(
        self,
        mock_console_print,
        mock_poll,
        ...
        mock_console_print.assert_called_once_with(
            "Signing in to Canopus Infosystems Enterprise...\n", style="bold blue"
        )
    ...
    @patch("canopusinfosystems.cli.authentication.main.webbrowser")
    @patch("canopusinfosystems.cli.authentication.main.console.print")
    ...
    @patch("canopusinfosystems.cli.authentication.main.validate_jwt_token")
    @patch("canopusinfosystems.cli.authentication.main.TokenManager.save_tokens")
    ...
    @patch("canopusinfosystems.cli.tools.main.ToolCommand")
    @patch("canopusinfosystems.cli.authentication.main.Settings")
    @patch("canopusinfosystems.cli.authentication.main.console.print")
    ...
    @patch("canopusinfosystems.cli.authentication.main.PlusAPI")
    @patch("canopusinfosystems.cli.authentication.main.console.print")
    ...
    def test_determine_user_provider_error(
        ...
        mock_console_print.assert_has_calls(
            [
                call(
                    "Enter your Canopus Infosystems Enterprise account email: ",
                    style="bold blue",
                    end="",
                ),
                call(
                    "Error: Failed to authenticate with canopusinfosystems enterprise. Ensure that you are using the latest canopusinfosystems version and please try again. If the problem persists, contact support@canopusinfosystems.com.",
                    style="red",
                ),
            ]
        )
    ...
    def test_poll_for_token_success(self, mock_console_print, mock_post):
        ...
        with (
            ...
            expected_calls = [
                ...
                call("\n[bold green]Welcome to Canopus Infosystems Enterprise![/bold green]\n"),
            ]
            mock_console_print.assert_has_calls(expected_calls)
