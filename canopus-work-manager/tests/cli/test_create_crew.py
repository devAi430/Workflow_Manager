...
from canopusinfosystems.cli.create_crew import create_crew, create_folder_structure
...
@mock.patch("canopusinfosystems.cli.create_crew.copy_template")
@mock.patch("canopusinfosystems.cli.create_crew.write_env_file")
@mock.patch("canopusinfosystems.cli.create_crew.load_env_vars")
def test_create_crew_with_trailing_slash_creates_valid_project(mock_load_env, mock_write_env, mock_copy_template, temp_dir):
    ...
    with tempfile.TemporaryDirectory() as work_dir:
        with mock.patch("canopusinfosystems.cli.create_crew.create_folder_structure") as mock_create_folder:
...
@mock.patch("canopusinfosystems.cli.create_crew.create_folder_structure")
@mock.patch("canopusinfosystems.cli.create_crew.copy_template")
@mock.patch("canopusinfosystems.cli.create_crew.load_env_vars")
@mock.patch("canopusinfosystems.cli.create_crew.get_provider_data")
@mock.patch("canopusinfosystems.cli.create_crew.select_provider")
@mock.patch("canopusinfosystems.cli.create_crew.select_model")
