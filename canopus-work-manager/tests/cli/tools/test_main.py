...
from canopusinfosystems.cli.authentication.utils import TokenManager
from canopusinfosystems.cli.tools.main import ToolCommand
...
@patch("canopusinfosystems.cli.tools.main.subprocess.run")
...
@patch("canopusinfosystems.cli.tools.main.subprocess.run")
@patch("canopusinfosystems.cli.plus_api.PlusAPI.get_tool")
@patch("canopusinfosystems.cli.tools.main.ToolCommand._print_current_organization")
...
@patch("canopusinfosystems.cli.tools.main.git.Repository.is_synced", return_value=False)
...
@patch("canopusinfosystems.cli.tools.main.get_project_name", return_value="sample-tool")
@patch("canopusinfosystems.cli.tools.main.get_project_version", return_value="1.0.0")
@patch("canopusinfosystems.cli.tools.main.get_project_description", return_value="A sample tool")
@patch("canopusinfosystems.cli.tools.main.subprocess.run")
@patch("canopusinfosystems.cli.tools.main.os.listdir", return_value=["sample-tool-1.0.0.tar.gz"])
@patch(
    "canopusinfosystems.cli.tools.main.open",
    new_callable=unittest.mock.mock_open,
    read_data=b"sample tarball content",
)
@patch("canopusinfosystems.cli.plus_api.PlusAPI.publish_tool")
@patch("canopusinfosystems.cli.tools.main.git.Repository.is_synced", return_value=False)
@patch(
    "canopusinfosystems.cli.tools.main.extract_available_exports",
...
@patch("canopusinfosystems.cli.plus_api.PlusAPI.publish_tool")
@patch("canopusinfosystems.cli.tools.main.git.Repository.is_synced", return_value=True)
@patch(
    "canopusinfosystems.cli.tools.main.extract_available_exports",
    return_value=[{"name": "SampleTool"}],
)
...
@patch("canopusinfosystems.cli.tools.main.Settings")
