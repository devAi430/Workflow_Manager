...
from canopusinfosystems.cli import evaluate_crew
...
@mock.patch("canopusinfosystems.cli.evaluate_crew.subprocess.run")
...
@mock.patch("canopusinfosystems.cli.evaluate_crew.click")
