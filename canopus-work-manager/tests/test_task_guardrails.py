...
from canopusinfosystems import Agent, Task
from canopusinfosystems.llm import LLM
from canopusinfosystems.tasks.hallucination_guardrail import HallucinationGuardrail
...
def test_guardrail_when_an_error_occurs(sample_agent, task_output):
    with (
        patch(
            "canopusinfosystems.Agent.kickoff",
