...
from canopusinfosystems.flow.flow import Flow, listen, start
...
from canopusinfosystems.utilities.events.event_types import ToolUsageFinishedEvent
from canopusinfosystems.utilities.events.flow_events import (
    FlowCreatedEvent,
    FlowFinishedEvent,
    FlowStartedEvent,
...
from canopusinfosystems.utilities.events.task_events import (
    TaskCompletedEvent,
    TaskFailedEvent,
    TaskStartedEvent,
)
from canopusinfosystems.utilities.events.tool_usage_events import (
    ToolUsageErrorEvent,
)
...
def test_llm_emits_call_failed_event():
    ...
    with patch("canopusinfosystems.llm.litellm.completion", side_effect=Exception(error_message)):
        llm = LLM(model="gpt-4o-mini")
