...
from canopusinfosystems.utilities.evaluators.task_evaluator import (
    TaskEvaluator,
...
@patch("canopusinfosystems.utilities.evaluators.task_evaluator.TrainingConverter")
...
@patch("canopusinfosystems.utilities.converter.Converter.to_pydantic")
@patch("canopusinfosystems.utilities.training_converter.TrainingConverter._convert_field_by_field")
