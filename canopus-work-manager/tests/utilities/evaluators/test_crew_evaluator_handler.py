...
from canopusinfosystems.utilities.evaluators.crew_evaluator_handler import (
    CrewEvaluator,
...
class InternalCrewEvaluator:
    ...
    @mock.patch("canopusinfosystems.utilities.evaluators.crew_evaluator_handler.Console")
    @mock.patch("canopusinfosystems.utilities.evaluators.crew_evaluator_handler.Table")
