...
from canopusinfosystems.utilities.converter import (
    Converter,
    ConverterError,
    convert_to_model,
...
from canopusinfosystems.utilities.pydantic_schema_parser import PydanticSchemaParser
# Tests for enums
...
def test_convert_to_model_with_invalid_json():
    ...
    with patch("canopusinfosystems.utilities.converter.handle_partial_json") as mock_handle:
...
def test_handle_partial_json_with_invalid_partial(mock_agent):
    ...
    with patch("canopusinfosystems.utilities.converter.convert_with_instructions") as mock_convert:
...
@patch("canopusinfosystems.utilities.converter.create_converter")
@patch("canopusinfosystems.utilities.converter.get_conversion_instructions")
...
def test_convert_with_instructions_failure(
    ...
    result = "Some text to convert"
    with patch("canopusinfosystems.utilities.converter.Printer") as mock_printer:
        output = convert_with_instructions(result, SimpleModel, False, mock_agent)
