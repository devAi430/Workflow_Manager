...
def test_interpolate_only():
    ...
    result = interpolate_only(
        input_string=normal_string, inputs={"name": "John", "place": "Canopus Infosystems"}
    )
    assert result == "Hello John, welcome to Canopus Infosystems!"
...
def test_task_config_prioritize_tasks_scenario():
    ...
    from canopusinfosystems import Agent
