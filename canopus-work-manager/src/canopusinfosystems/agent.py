...
from canopusinfosystems.agents.crew_agent_executor import CrewAgentExecutor
...
from canopusinfosystems.knowledge.utils.knowledge_utils import extract_knowledge_context
from canopusinfosystems.lite_agent import LiteAgent, LiteAgentOutput
from canopusinfosystems.llm import BaseLLM
from canopusinfosystems.memory.contextual.contextual_memory import ContextualMemory
from canopusinfosystems.security import Fingerprint
...
from canopusinfosystems.utilities import Converter, Prompts
from canopusinfosystems.utilities.agent_utils import (
    get_tool_names,
    load_agent_from_repository,
    parse_tools,
    render_text_description_and_args,
)
from canopusinfosystems.utilities.constants import TRAINED_AGENTS_DATA_FILE, TRAINING_DATA_FILE
from canopusinfosystems.utilities.converter import generate_model_description
from canopusinfosystems.utilities.events.agent_events import (
...
from canopusinfosystems.utilities.events.knowledge_events import (
...
from canopusinfosystems.utilities.token_counter_callback import TokenCalcHandler
...
class Agent(BaseAgent):
    ...
    def execute_task(
        ...
        if self.reasoning:
            try:
                from canopusinfosystems.utilities.reasoning_handler import (
                    AgentReasoning,
