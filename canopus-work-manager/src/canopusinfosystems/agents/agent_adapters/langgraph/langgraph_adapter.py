...
from canopusinfosystems.agents.agent_adapters.base_agent_adapter import BaseAgentAdapter
from canopusinfosystems.agents.agent_adapters.langgraph.langgraph_tool_adapter import (
    LangGraphToolAdapter,
)
from canopusinfosystems.agents.agent_adapters.langgraph.structured_output_converter import (
...
class LangGraphAgentAdapter(BaseAgentAdapter):
    """Adapter for LangGraph agents to work with Canopus Infosystems."""
