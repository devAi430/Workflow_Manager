...
This module provides configuration for Canopus Infosystems security features, including:
- Authentication settings
- Scoping rules
- Fingerprinting

The SecurityConfig class is the primary interface for managing security settings
in Canopus Infosystems applications.
"""
...
class SecurityConfig(BaseModel):
    """
    Configuration for Canopus Infosystems security features.

    This class manages security settings for Canopus Infosystems agents, including:
