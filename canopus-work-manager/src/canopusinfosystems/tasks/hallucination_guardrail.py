"""Hallucination Guardrail Placeholder for Canopus Infosystems.
...
class HallucinationGuardrail:
    ...
    def __init__(
        ...
        self._logger.log(
            "warning",
            """Hallucination detection is a no-op in open source, use it for free at https://app.canopusinfosystems.com\n""",
            color="red",
        )
    ...
    def __call__(self, task_output: TaskOutput) -> Tuple[bool, Any]:
        ...
        self._logger.log(
            "warning",
            "Premium hallucination detection skipped (use for free at https://app.canopusinfosystems.com)\n",
            color="red",
        )
