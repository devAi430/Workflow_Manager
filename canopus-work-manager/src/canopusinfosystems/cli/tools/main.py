...
from canopusinfosystems.cli.utils import (
...
class ToolCommand(BaseCommand, PlusAPIMixin):
    """
    A class to handle tool repository related operations for Canopus Infosystems projects.
    """
    ...
    def publish(self, is_public: bool, force: bool = False):
        ...
        console.print(
            ...
            + f"You can monitor the status or access your tool here:\nhttps://app.canopusinfosystems.com/crewai_plus/tools/{published_handle}",
            style="bold green",
        )
    ...
    def login(self) -> None:
        ...
        if login_response.status_code != 200:
            console.print(
                "Authentication failed. Verify access to the tool repository, or try `canopusinfosystems login`. ",
                style="bold red",
            )
            raise SystemExit
