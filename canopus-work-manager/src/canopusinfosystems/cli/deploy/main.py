...
from canopusinfosystems.cli import git
from canopusinfosystems.cli.command import BaseCommand, PlusAPIMixin
from canopusinfosystems.cli.utils import fetch_and_json_env_file, get_project_name
...
class DeployCommand(BaseCommand, PlusAPIMixin):
    """
    A class to handle deployment-related operations for Canopus Infosystems projects.
    """
    ...
    def _display_deployment_info(self, json_response: Dict[str, Any]) -> None:
        ...
        console.print("canopusinfosystems deploy status")
        console.print(" or")
        console.print(f"canopusinfosystems deploy status --uuid \"{json_response['uuid']}\"")
    ...
    def _display_creation_success(self, json_response: Dict[str, Any]) -> None:
        ...
        console.print("canopusinfosystems deploy push")
        console.print(" or")
        console.print(f"canopusinfosystems deploy push --uuid {json_response['uuid']}")
    ...
    def _display_no_crews_message(self) -> None:
        ...
        console.print("  canopusinfosystems create crew <crew_name>", style="green")
