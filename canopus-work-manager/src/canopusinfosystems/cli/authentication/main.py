...
class AuthenticationCommand:
    ...
    def login(self) -> None:
        """Sign up to Canopus Infosystems+"""
        ...
        console.print("Signing in to Canopus Infosystems Enterprise...\n", style="bold blue")
    ...
    def _determine_user_provider(self) -> str:
        ...
        console.print(
            "Enter your Canopus Infosystems Enterprise account email: ", style="bold blue", end=""
        )
        email = input()
