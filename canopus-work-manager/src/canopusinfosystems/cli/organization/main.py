...
class OrganizationCommand(BaseCommand, PlusAPIMixin):
    ...
    def list(self):
        try:
            ...
            if e.response.status_code == 401:
                console.print("You are not logged in to any organization. Use 'canopusinfosystems login' to login.", style="bold red")
                return
    ...
    def current(self):
        ...
        if settings.org_uuid:
            ...
            console.print("Use 'canopusinfosystems org list' to see available organizations.", style="yellow")
            console.print("Use 'canopusinfosystems org switch <id>' to switch to an organization.", style="yellow")
