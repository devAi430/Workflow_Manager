...
class PlusAPI:
    """
    This class exposes methods for working with the Canopus Infosystems+ API.
    """
    ...
    def __init__(self, api_key: str) -> None:
        ...
        self.headers = {
            ...
            "User-Agent": f"Canopus Infosystems-CLI/{get_crewai_version()}",
            "X-Crewai-Version": get_crewai_version(),
        }
        settings = Settings()
        if settings.org_uuid:
            self.headers["X-Crewai-Organization-Id"] = settings.org_uuid
        self.base_url = getenv("CANOPUSINFOSYSTEMS_BASE_URL", "https://app.canopusinfosystems.com")
