...
from canopusinfosystems.cli.constants import ENV_VARS
from canopusinfosystems.crew import Crew
from canopusinfosystems.flow import Flow
...
def _get_project_attribute(
    ...
    try:
        ...
        if not any(True for dep in dependencies if "canopusinfosystems" in dep):
            raise Exception("canopusinfosystems is not in the dependencies.")
...
def is_valid_tool(obj):
    from canopusinfosystems.tools.base_tool import Tool
...
def _print_no_tools_warning():
    ...
    console.print(
        ...
        "[green]from canopusinfosystems.tools import BaseTool, tool\n\n"
        "# Tool class example\n"
